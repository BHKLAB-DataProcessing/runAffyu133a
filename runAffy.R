...
file.paths <- file.path("/pfs/BrainArray/",c(list.files(pattern="^hthgu133ahsensg*", path="/pfs/BrainArray/"),
                list.files(pattern="^pd.hthgu133a.hs.ensg*", path="/pfs/BrainArray/")))
